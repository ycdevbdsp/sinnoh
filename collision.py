...
class Ui_CollisionEditor(object):
    def setupUi(self, CollisionEditor):
        ...
        self.uiColHeightSB.setGeometry(QtCore.QRect(70, 210, 42, 22))
        ...
        self.uiColWidthSB.setGeometry(QtCore.QRect(70, 180, 42, 22))
        self.uiColWidthSB.setObjectName("uiColWidthSB")
        self.btnColSaveMatrix = QtWidgets.QPushButton(CollisionEditor)
        self.btnColSaveMatrix.setGeometry(QtCore.QRect(70, 140, 75, 23))
