...
class Ui_CollisionEditor(object):
    def setupUi(self, CollisionEditor):
        ...
        self.uiEventsScript = QtWidgets.QPlainTextEdit(self.tabEvents)
        self.uiEventsScript.setGeometry(QtCore.QRect(10, 620, 751, 181))
        self.uiEventsScript.setObjectName("uiEventsScript")
        self.label_3 = QtWidgets.QLabel(self.tabEvents)
        self.label_3.setGeometry(QtCore.QRect(10, 600, 47, 13))
    ...
    def retranslateUi(self, CollisionEditor):
        ...
        self.label_3.setText(_translate("CollisionEditor", "Script"))
